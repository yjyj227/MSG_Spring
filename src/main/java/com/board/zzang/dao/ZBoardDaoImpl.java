...
@Service("zBoardDaoImpl") // =>컨트롤러와 DB(DAO)사이의 중간역할을 하는 클래스에게 부여(빈등록)
public class ZBoardDaoImpl extends SqlSessionDaoSupport implements ZBoardDao {

	// 댓글 수 담기
	public List<ZBoardDTO> getCommentCountForList(Map<String, Object> map) {
		System.out.println("getCommentCountForList() 호출됨");
		List<ZBoardDTO> list=getSqlSession().selectList("selectCommentCount_Z", map);
	...
	public List<ZBoardDTO> list(Map<String, Object> map) {
		List<ZBoardDTO> list=getSqlSession().selectList("selectList_Z", map);
		return list;
	};

	public List<ZBoardDTO> list_zref(Map<String, Object> map) {
		List<ZBoardDTO> list=getSqlSession().selectList("selectListZref_Z", map);
		return list;
	};

	public List<ZBoardDTO> list_hot(Map<String, Object> map) {
		List<ZBoardDTO> list=getSqlSession().selectList("selectListHot_Z", map);
		return list;
	};
	...
	public int getRowCount(Map<String, Object> map) {
		return getSqlSession().selectOne("selectCount_Z", map);
	};
	@Override
	public int getRowCount_zref(Map<String, Object> map) {
		// TODO Auto-generated method stub
		return getSqlSession().selectOne("selectCountZref_Z", map);
	}
	@Override
	public int getRowCount_hot(Map<String, Object> map) {
		// TODO Auto-generated method stub
		return getSqlSession().selectOne("selectCountHot_Z", map);
	}
	...
	public int getNewNum() {
		int newnum=0;
		if ((Integer)getSqlSession().selectOne("getNewNum_Z") != null) {
			newnum=(Integer)getSqlSession().selectOne("getNewNum_Z");
		}
	...
	public int insert(ZBoardDTO board) {
		return getSqlSession().insert("insertBoard_Z", board);
		/*
	...
	public int pointupA(String mem_id) {
		// TODO Auto-generated method stub
		return getSqlSession().update("pointupA_Z", mem_id);
	}

	// 5. 글상세보기
	// public BoardCommand selectBoard(Integer seq);
	public ZBoardDTO getBoard(Integer num) {
		return (ZBoardDTO)getSqlSession().selectOne("selectBoard_Z", num);
	};

	// 6. 게시물번호에 해당하는 조회수 증가
	// public void updateHit(Integer seq);
	public void updateHit(Integer num) {
		getSqlSession().update("updateHit_Z", num);
	};

	// 7. 글수정하기
	// public void update(BoardCommand board);
	public void update(ZBoardDTO board) {
		getSqlSession().update("updateBoard_Z", board);
	};

	// 8. 글삭제하기
	// public void delete(Integer seq);
	public int delete(Integer num) {
		return getSqlSession().delete("deleteBoard_Z", num);
	};
	// 8-2. 글 삭제시 포인트 회수
	@Override
	public int pointdownA(String mem_id) {
		// TODO Auto-generated method stub
		return getSqlSession().update("pointdownA_Z", mem_id);
	}
	...
	public int deleteComment(Integer num) {
		// TODO Auto-generated method stub
		return getSqlSession().delete("deleteBoardComment_Z", num);
	}
	...
	public int deleteScrap(ZBoardDTO board) {
		// TODO Auto-generated method stub
		return getSqlSession().delete("deleteBoardScrap_Z", board);
	}
	...
	public int getPoint(String mem_id) {
		// TODO Auto-generated method stub
		return (Integer)getSqlSession().selectOne("getPoint_Z", mem_id);
	};
	//등급 구하기
	@Override
	public int getGrade(String mem_id) {
		// TODO Auto-generated method stub
		return (Integer)getSqlSession().selectOne("getGrade_Z", mem_id);
	}
	...
	public int changeGrade1(String mem_id) {
		// TODO Auto-generated method stub
		return getSqlSession().update("changeGrade1_Z", mem_id);
	}
	@Override
	public int changeGrade2(String mem_id) {
		// TODO Auto-generated method stub
		return getSqlSession().update("changeGrade2_Z", mem_id);
	}
	@Override
	public int changeGrade3(String mem_id) {
		// TODO Auto-generated method stub
		return getSqlSession().update("changeGrade3_Z", mem_id);
	}
	@Override
	public int changeGrade4(String mem_id) {
		// TODO Auto-generated method stub
		return getSqlSession().update("changeGrade4_Z", mem_id);
	}
	@Override
	public int changeGrade5(String mem_id) {
		// TODO Auto-generated method stub
		return getSqlSession().update("changeGrade5_Z", mem_id);
	}
