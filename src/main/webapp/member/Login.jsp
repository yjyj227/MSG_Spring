...
<body id="page-top" class="bg-dark" onload="login.mem_id.focus()">
        <!-- Navigation-->
		...
		<section class="page-section bg-dark" id="portfolio">
			...
			<div class="col-md-12 pagetitle">로그인</div>
			<div class="col-md-12 logform">
					<form role="form" class="form-horizontal" name="login" method="post" action="Login.do">
					<div class="col-md-12">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="password" class="form-control" placeholder="비밀번호" name="log_passwd">
							</div>
						</div>
						<div class="col-md-12"></div>
						<div class="form-group">
							<div class="col-md-12" align="center">
								<button type="submit" class="btn btn-default btn-sm" onclick="loginCheck()">로그인</button>
							</div>
						</div>
