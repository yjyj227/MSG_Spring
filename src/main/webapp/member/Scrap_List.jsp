				...
				<table class="table table-hover">
					...
					<c:forEach var="article" items="${articleList}">
						<tr>
							...
							<a href="${article.s_url}">${article.s_title}</a>
							</td>
							...
							<td width="5%" align="center">
								...
								onclick="location.href='Scrap_Delete.do?scrap_number=${article.scrap_number}&s_category=${article.s_category}&s_number=${article.s_number}'">삭제</button>
							</td>
						</tr>
