...
<body id="page-top" class="bg-dark">
		...
		<section class="page-section bg-dark" id="portfolio">
			...
			<div class="form-group">
				<form role="form" class="form-horizontal" enctype="multipart/form-data" name="mupdateform" method="post" action="M_Update.do" onsubmit="return writeSave()">
					...
					<input type="hidden" name="m_nickname" value="${article.m_nickname}">
				<table class="table">
				<thead>
					...
					<tr>
						<td>
							<div class="form-group refform col-md-1">
								<select class="form-control" name="m_ref">
									<option value="${article.m_ref}">
										<c:choose>
							...
							<div class="form-group cateform col-md-2">
								<select class="form-control" name="m_category">
									<option value="${article.m_category}">
										<c:choose>
									...
									<option value="30">시리즈 선택</option>
									<option value="31">어벤져스</option>
									<option value="32">아이언맨</option>
									<option value="33">스파이더맨</option>
									<option value="34">블랙 팬서</option>
									<option value="35">가디언즈 오브 갤럭시</option>
								</select>
							</div>
							
							<div class="col-md-9">
								<input type="text" name="m_title" class="form-control" value="${article.m_title}">
							</div>
						</td>
					</tr>
				</thead>
					...
					<tr>
						<td>
						<textarea name="m_body" rows="20" class="form-control">${article.m_body}</textarea>
						</td>
					</tr>	
					...
					<tr>
						...
						<button type="button" class="btn btn-default btn-sm" onclick="location.href='M_List.do?m_ref=${article.m_ref}'">목록으로</button>
						</div>
