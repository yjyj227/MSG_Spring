...
<body id="page-top" class="bg-dark">
		...
		<section class="page-section bg-dark" id="portfolio">
			...
			if (result) {
				location.href="M_CommentDeleteProc.do?m_cnumber=${param.m_cnumber}&m_number=${param.m_number}&m_cref=${param.m_cref}&m_cre_level=${param.m_cre_level}&m_cmem_id=${param.m_cmem_id}"
			}else{
				history.back();
			}
		</script>
