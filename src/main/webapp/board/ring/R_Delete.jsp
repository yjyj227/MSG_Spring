...
<body id="page-top" class="bg-dark">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
						...
						<li class="disabled"><a class="nav-link" href="MyPage.do"><c:out value="${mem_nickname}" />님 환영합니다.</a></li>
		...
		<section class="page-section bg-dark" id="portfolio">
			...
			if (result) {
				location.href="R_DeleteProc.do?r_number=${param.r_number}&r_title=${param.r_title}&content_mem_id=${param.content_mem_id}"
			}else{
				history.back();
			}
		</script>
