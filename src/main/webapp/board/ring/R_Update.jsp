...
<body id="page-top" class="bg-dark">
		...
		<section class="page-section bg-dark" id="portfolio">
			...
			<div class="form-group">
				<form role="form" class="form-horizontal" enctype="multipart/form-data" name="rupdateform" method="post" action="R_Update.do" onsubmit="return writeSave()">
					...
					<input type="hidden" name="r_nickname" value="${article.r_nickname}">
				<table class="table">
				<thead>
						...
						<td>
							...
							<div class="form-group cateform col-md-2">
								<select class="form-control" name="r_category">
									<option value="${article.r_category}">
										<c:choose>
							...
							<div class="col-md-9">
								<input type="text" name="r_title" class="form-control" value="${article.r_title}">
							</div>
						</td>
					</tr>
				</thead>
					...
					<tr>
						<td>
						<textarea name="r_body" rows="20" class="form-control">${article.r_body}</textarea>
						</td>
					</tr>	
					...
					<tr>
						...
						<button type="button" class="btn btn-default btn-sm" onclick="location.href='R_List.do?r_ref=${article.r_ref}'">목록으로</button>
						</div>
