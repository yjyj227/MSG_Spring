...
<body id="page-top" class="bg-dark">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
						...
						<li class="disabled"><a class="nav-link"><c:out value="${mem_nickname}" />님 환영합니다.</a></li>
                        ...
                        <li class="nav-item"><a class="nav-link" href="Main.do#about">About</a></li>
		...
		<section class="page-section bg-dark" id="portfolio">
			...
			if (result) {
				location.href="R_CommentDeleteProc.do?r_cnumber=${param.r_cnumber}&r_number=${param.r_number}&r_cref=${param.r_cref}&r_cre_level=${param.r_cre_level}&r_cmem_id=${param.r_cmem_id}"
			}else{
				history.back();
			}
		</script>
