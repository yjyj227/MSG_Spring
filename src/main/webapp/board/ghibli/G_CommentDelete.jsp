...
<body id="page-top" class="bg-dark">
		...
		<section class="page-section bg-dark" id="portfolio">
			...
			if (result) {
				location.href="G_CommentDeleteProc.do?g_cnumber=${param.g_cnumber}&g_number=${param.g_number}&g_cref=${param.g_cref}&g_cre_level=${param.g_cre_level}&g_cmem_id=${param.g_cmem_id}"
			}else{
				history.back();
			}
		</script>
