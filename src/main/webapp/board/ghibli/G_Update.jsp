...
<body id="page-top" class="bg-dark">
		...
		<section class="page-section bg-dark" id="portfolio">
			...
			<div class="form-group">
				<form role="form" class="form-horizontal" enctype="multipart/form-data" name="gupdateform" method="post" action="G_Update.do" onsubmit="return writeSave()">
					...
					<input type="hidden" name="g_nickname" value="${article.g_nickname}">
				<table class="table">
				<thead>
						...
						<td>
							...
							<div class="form-group cateform col-md-2">
								<select class="form-control" name="g_category">
									<option value="${article.g_category}">
										<c:choose>
							...
							<div class="col-md-9">
								<input type="text" name="g_title" class="form-control" value="${article.g_title}">
							</div>
						</td>
					</tr>
				</thead>
					...
					<tr>
						<td>
						<textarea name="g_body" rows="20" class="form-control">${article.g_body}</textarea>
						</td>
					</tr>	
					...
					<tr>
						...
						<button type="button" class="btn btn-default btn-sm" onclick="location.href='G_List.do?g_ref=${article.g_ref}'">목록으로</button>
						</div>
