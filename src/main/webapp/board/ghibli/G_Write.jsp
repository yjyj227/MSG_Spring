...
<body id="page-top" class="bg-dark">
		...
		<section class="page-section bg-dark" id="portfolio">
			...
			<div class="form-group">
				<form role="form" class="form-horizontal" enctype="multipart/form-data" name="gwriteform" method="post" action="G_Write.do" onsubmit="return writeSave()">
				...
				<thead>
					...
					<tr>
						...
						<button type="button" class="btn btn-default btn-sm" onclick="location.href='G_List.do'">목록으로</button>
						</div>
						<div class="col-md-8" align="center">
						<button type="submit" class="btn btn-default btn-sm" btn-sm>등록</button>&nbsp;&nbsp;&nbsp;
