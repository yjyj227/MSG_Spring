...
<body id="page-top" class="bg-dark">
		...
		<section class="page-section bg-dark" id="portfolio">
			...
			<div class="form-group">
				<form role="form" class="form-horizontal" enctype="multipart/form-data" name="hwriteform" method="post" action="H_Write.do" onsubmit="return writeSave()">
					<!-- 입력하지 않고 매개변수로 전달해서 테이블에 저장 -->
					<input type="hidden" name="h_number" value="${h_number}">
					<input type="hidden" name="mem_id" value="${mem_id}">
					<input type="hidden" name="h_nickname" value="${mem_nickname}">
				<table class="table">
				<thead>
					...
					<tr>
						<td>
							...
							<div class="col-md-9">
								<input type="text" name="h_title" placeholder="제목을 입력하세요." class="form-control">
							</div>
						</td>
					</tr>
				</thead>
					...
					<tr>
						<td>
						<textarea name="h_body" rows="20" placeholder="내용을 입력하세요." class="form-control"></textarea>
						</td>
					</tr>	
					
					<tr>
						<td>
						&nbsp;&nbsp;<input type="file" name="upload" class="btn-xs upload">
						<font style="font-size: 12px">jpg, jpeg, png, gif 파일만 지원 가능합니다.</font>
						</td>
					</tr>
					...
					<tr>
						...
						<button type="button" class="btn btn-default btn-sm" onclick="location.href='H_List.do'">목록으로</button>
						</div>
