...
<body id="page-top" class="bg-dark">
		...
		<section class="page-section bg-dark" id="portfolio">
			...
			if (result) {
				location.href="H_CommentDeleteProc.do?h_cnumber=${param.h_cnumber}&h_number=${param.h_number}&h_cref=${param.h_cref}&h_cre_level=${param.h_cre_level}&h_cmem_id=${param.h_cmem_id}"
			}else{
				history.back();
			}
		</script>
