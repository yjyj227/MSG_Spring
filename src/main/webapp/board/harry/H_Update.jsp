...
<body id="page-top" class="bg-dark">
		...
		<section class="page-section bg-dark" id="portfolio">
			...
			<div class="col-md-12 pagetitle" align="center">글 수정</div>
			<div class="form-group">
				<form role="form" class="form-horizontal" enctype="multipart/form-data" name="hupdateform" method="post" action="H_Update.do" onsubmit="return writeSave()">
					...
					<input type="hidden" name="h_nickname" value="${article.h_nickname}">
				<table class="table">
				<thead>
					...
					<tr>
						<td>
							<div class="form-group refform col-md-1">
								<select class="form-control" name="h_ref">
									<option value="${article.h_ref}">
										<c:choose>
							...
							<div class="form-group cateform col-md-2">
								<select class="form-control" name="h_category">
									<option value="${article.h_category}">
										<c:choose>
									...
									<option value="10">시리즈 선택</option>
									<option value="11">마법사의 돌</option>
									<option value="12">비밀의 방</option>
									<option value="13">아즈카반의 죄수</option>
									<option value="14">불의 잔</option>
									<option value="15">불사조 기사단</option>
									<option value="16">혼혈 왕자</option>
									<option value="17">죽음의 성물 - 1부</option>
									<option value="18">죽음의 성물 - 2부</option>
								</select>
							</div>
							
							<div class="col-md-9">
								<input type="text" name="h_title" class="form-control" value="${article.h_title}">
							</div>
						</td>
					</tr>
				</thead>
					...
					<tr>
						<td>
						<textarea name="h_body" rows="20" class="form-control">${article.h_body}</textarea>
						</td>
					</tr>	
					...
					<tr>
						...
						<font style="font-size: 12px">첨부된 파일(${article.h_filename})&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;jpg, jpeg, png, gif 파일만 지원 가능합니다.</font>
						</c:if>
						</td>
					</tr>
					...
					<tr>
						...
						<button type="button" class="btn btn-default btn-sm" onclick="location.href='H_List.do?h_ref=${article.h_ref}'">목록으로</button>
						</div>
