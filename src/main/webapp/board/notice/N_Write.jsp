...
<body id="page-top" class="bg-dark">
		...
		<section class="page-section bg-dark" id="portfolio">
			...
			<div class="form-group">
				<form role="form" class="form-horizontal" enctype="multipart/form-data" name="nwriteform" method="post" action="N_Write.do" onsubmit="return writeSave()">
					<!-- 입력하지 않고 매개변수로 전달해서 테이블에 저장 -->
					<input type="hidden" name="notice_number" value="${notice_number}">
					<input type="hidden" name="admin_id" value="${mem_id}">
				<table class="table">
				<thead>
				
					<tr>
						<td>
							<input type="text" name="not_title" placeholder="제목을 입력하세요." class="form-control">
						</td>
					</tr>
				</thead>
					...
					<tr>
						<td>
						<textarea name="not_body" rows="20" placeholder="내용을 입력하세요." class="form-control"></textarea>
						</td>
					</tr>	
