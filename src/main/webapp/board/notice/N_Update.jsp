...
<body id="page-top" class="bg-dark">
		...
		<section class="page-section bg-dark" id="portfolio">
			...
			<div class="form-group">
				<form role="form" class="form-horizontal" enctype="multipart/form-data" name="hupdateform" method="post" action="N_Update.do" onsubmit="return writeSave()">
				...
				<thead>
					...
					<tr>
						<td>
							<input type="text" name="not_title" class="form-control" value="${article.not_title}">
						</td>
					</tr>
				</thead>
					...
					<tr>
						<td>
						<textarea name="not_body" rows="20" class="form-control">${article.not_body}</textarea>
						</td>
					</tr>	
					...
					<tr>
						...
						<button type="button" class="btn btn-default btn-sm" onclick="location.href='N_List.do'">목록으로</button>
						</div>
