...
<body id="page-top" class="bg-dark">
		...
		<section class="page-section bg-dark" id="portfolio">
			...
			<ul class="pagination">
				...
				<li><a href="N_List.do?pageNum=${pgList.startPage-pgList.blockSize}&search=${search}&searchtext=${searchtext}"> < </a></li>
				</c:if>
			
				<c:forEach var="i" begin="${pgList.startPage}"	end="${pgList.endPage}">
				<li>
				<a href="N_List.do?pageNum=${i}&search=${search}&searchtext=${searchtext}">
				...
				<li><a href="N_List.do?pageNum=${pgList.startPage+pgList.blockSize}&search=${search}&searchtext=${searchtext}"> > </a></li>
					...
					<div class="col-md-offset-2 col-md-8 col-md-offset-2">
						<form action="N_List.do" name="bus">
							<div class="col-md-3">
							<select class="form-control" name="search">
								<option value="n_all">전체</option>
								<option value="n_title">제목</option>
								<option value="n_body">본문</option>
							</select>
							</div>
							<div class="col-md-7">
				...
				<c:if test="${!empty mem_id}">
					<c:if test="${mem_id.equals('admin')}">
						<div class="col-md-1"><button type="button" class="btn btn-default btn-sm" onclick="location.href='N_Write.do'">글쓰기</button></div>
					</c:if>
				</c:if>
			</div>
