...
<body id="page-top" class="bg-dark">
		...
		<section class="page-section bg-dark" id="portfolio">
			...
			if (result) {
				location.href="Z_CommentDeleteProc.do?z_cnumber=${param.z_cnumber}&z_number=${param.z_number}&z_cref=${param.z_cref}&z_cre_level=${param.z_cre_level}&z_cmem_id=${param.z_cmem_id}"
			}else{
				history.back();
			}
		</script>
