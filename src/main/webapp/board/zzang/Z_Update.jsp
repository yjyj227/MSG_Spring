...
<body id="page-top" class="bg-dark">
		...
		<section class="page-section bg-dark" id="portfolio">
			...
			<div class="form-group">
				<form role="form" class="form-horizontal" enctype="multipart/form-data" name="zupdateform" method="post" action="Z_Update.do" onsubmit="return writeSave()">
					...
					<input type="hidden" name="z_nickname" value="${article.z_nickname}">
				<table class="table">
				<thead>
					...
					<tr>
						<td>
							<div class="form-group refform col-md-1">
								<select class="form-control" name="z_ref">
									<option value="${article.z_ref}">
										<c:choose>
							...
							<div class="form-group cateform col-md-2">
								<select class="form-control" name="z_category">
									<option value="${article.z_category}">
										<c:choose>
									...
									<option value="20">시리즈 선택</option>
									<option value="21">헨더랜드의 대모험</option>
									<option value="22">암흑 마왕 대추적</option>
									<option value="23">전격! 돼지발굽 대작전</option>
								</select>
							</div>
							
							<div class="col-md-9">
								<input type="text" name="z_title" class="form-control" value="${article.z_title}">
							</div>
						</td>
					</tr>
				</thead>
					...
					<tr>
						<td>
						<textarea name="z_body" rows="20" class="form-control">${article.z_body}</textarea>
						</td>
					</tr>	
					...
					<tr>
						...
						<button type="button" class="btn btn-default btn-sm" onclick="location.href='Z_List.do?z_ref=${article.z_ref}'">목록으로</button>
						</div>
