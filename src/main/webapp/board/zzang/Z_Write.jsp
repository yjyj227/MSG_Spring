...
<body id="page-top" class="bg-dark">
		...
		<section class="page-section bg-dark" id="portfolio">
			...
			<div class="form-group">
				<form role="form" class="form-horizontal" enctype="multipart/form-data" name="zwriteform" method="post" action="Z_Write.do" onsubmit="return writeSave()">
					<!-- 입력하지 않고 매개변수로 전달해서 테이블에 저장 -->
					<input type="hidden" name="z_number" value="${z_number}">
					<input type="hidden" name="mem_id" value="${mem_id}">
					<input type="hidden" name="z_nickname" value="${mem_nickname}">
				<table class="table">
				<thead>
					...
					<tr>
						<td>
							...
							<div class="col-md-9">
								<input type="text" name="z_title" placeholder="제목을 입력하세요." class="form-control">
							</div>
						</td>
					</tr>
				</thead>
					...
					<tr>
						<td>
						<textarea name="z_body" rows="20" placeholder="내용을 입력하세요." class="form-control"></textarea>
						</td>
					</tr>	
					...
					<tr>
						...
						<button type="button" class="btn btn-default btn-sm" onclick="location.href='Z_List.do'">목록으로</button>
						</div>
