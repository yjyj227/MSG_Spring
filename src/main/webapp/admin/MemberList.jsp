		...
		<section class="page-section bg-dark" id="portfolio">
			...
			<div class="col-md-12"><!-- 검색기능 -->
				<div class="col-md-offset-3 col-md-6 col-md-offset-3">
					<form action="AdminPage.do" name="bus">
						<div class="col-md-3">
				...
				<table class="table table-hover">
					...
					<c:forEach var="member" items="${memberList}">
						<tr align="center">
    						...
    						<td width="15%">
    							<button type="button" class="btn btn-warning btn-xs" onclick="location.href='MemberModify.do?mem_id=${member.mem_id}'">수정</button>
    							<button type="button" class="btn btn-danger btn-xs" onclick="location.href='MemberDelete.do?member_id=${member.mem_id}'">삭제</button>
    						</td>
						</tr>
			...
			<ul class="pagination">
				...
				<li><a href="AdminPage.do?pageNum=${pgList.startPage-pgList.blockSize}"> < </a></li>
				</c:if>
			
				<c:forEach var="i" begin="${pgList.startPage}"	end="${pgList.endPage}">
				<li>
				<a href="AdminPage.do?pageNum=${i}">
