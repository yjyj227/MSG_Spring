		...
		if (result==false) {
     	...
     	<div class="row">
				<div class="col-md-offset-4 col-md-4 col-md-offset-4" align="center">
					...
					<form role="form" class="form-horizontal" name="del" method="post" action="MemberDelete.do?member_id=${param.member_id}">
						...
						<div class="form-group" align="center">
							<div class="col-xs-12 col-lg-12" align="center">
								<button type="button" class="btn btn-default" onclick="delCheck()">회원삭제</button>
